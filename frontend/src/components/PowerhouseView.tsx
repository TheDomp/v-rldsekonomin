...
const POWERHOUSES = [
    ...
    { code: 'CHN', name: 'China', color: 'border-red-500', shadow: 'shadow-red-500/20', flag: '🇨🇳' },
    { code: 'EUU', name: 'EU', color: 'border-blue-400', shadow: 'shadow-blue-400/20', flag: '🇪🇺' },
    { code: 'RUS', name: 'Russia', color: 'border-green-500', shadow: 'shadow-green-500/20', flag: '🇷🇺' },
];
                        ...
                        >
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <span className={clsx(
                                            ...
                                            {isLoading ? 'Fetching...' : (countryData?.healthIndex !== null ? `${countryData?.healthIndex}/100` : 'Data Missing')}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                                    ...
                                    <div className="text-right">
                                        <span className={clsx(
                                            ...
                                            {isLoading ? '-' : countryData?.metrics.gdpGrowth.value !== null ? `${countryData?.metrics.gdpGrowth.value.toFixed(1)}%` : 'N/A'}
                                        </span>
                                ...
                                <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                                    ...
                                    <div className="text-right">
                                        <span className={clsx(
                                            ...
                                            {isLoading ? '-' : countryData?.metrics.inflation.value !== null ? `${countryData?.metrics.inflation.value.toFixed(1)}%` : 'N/A'}
                                        </span>
                                        <span className="text-[10px] text-slate-500 block">
                                ...
                                <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                                    <div className="flex items-center gap-2 text-slate-300">
                                        ...
                                        <span className="text-sm">Public Debt</span>
                                    </div>
                                    <div className="text-right">
                                        <span className={clsx(
                                            "font-mono font-bold block",
                                            ...
                                            {isLoading ? '-' : countryData?.metrics.debtToGdp.value !== null ? `${countryData?.metrics.debtToGdp.value.toFixed(1)}%` : 'N/A'}
                                        </span>
                                        <span className="text-[10px] text-slate-500 block">
                            ...
                            {countryData && (countryData.metrics.debtToGdp === null || countryData.metrics.gdpGrowth === null) && (
                                <div className="mt-4 flex items-center gap-2 text-xs text-slate-500">
                                    ...
                                    <span>Some data not reported to World Bank</span>
                                </div>
                            )}
